  ...
  return (
    <div className="rules-layout">
      ...
      <section className="rules-section">
        ...
        <p className="small" style={{ marginBottom: 0 }}>
          Los certificados de consumo serán válidos únicamente en Barra Brava Los Yoses y Barra Brava Jacó.
        </p>
      </section>
      ...
      <section className="rules-section">
        ...
        <ol className="rules-list small" style={{ paddingLeft: 20 }}>
          <li>
            Se suman todos los goles que pusiste en tus pronósticos y se compara ese total con la cantidad real de goles del Mundial.
            Queda mejor posicionado quien esté más cerca del número real.
          </li>
      ...
      <section className="rules-section">
        ...
        <ul className="rules-list small" style={{ marginBottom: 8 }}>
          ...
          <li>Barra Brava se reserva el derecho de descalificar participantes que incumplan las reglas o afecten el desarrollo normal de la dinámica.</li>
